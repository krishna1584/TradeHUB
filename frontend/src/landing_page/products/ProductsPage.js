...
function ProductsPage() {
  return (
    <>
      ...
      <RightSection imageUrl="media/images/console.png" productName="Console" productDescrption="The central dashboard for your account. Gain insights into your trades and investments with in-depth reports and visualisations." />
      ...
      <p className="text-center fs-4">
        ...
        <a href="https://TradeHub.tech/" style={{ textDecoration: "none", color: "#387ed1" }}>
          TradeHub.tech
        </a>{" "}
        blog.
      </p>
